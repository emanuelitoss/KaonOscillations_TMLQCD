...
* License (GPL)
*
* Gauge covariance of Dw_xsf_dble()
*
*******************************************************************************/
...
int main(int argc,char *argv[])
{
   ...
   if (my_rank==0)
      printf("m0 = %.4e, mu= %.4e, csw = %.4e, cF = %.4e, dF=%.4e, zF=%.4e\n\n",
             swp.m0,mu,swp.csw,swp.cF,lat.dF,lat.zF);
   ...
   error(d>0.0,1,"main [check4.c]","Dw_xsf_dble() changes the input field");

   Dw_xsf_dble(mu,psd[0],psd[4]);
