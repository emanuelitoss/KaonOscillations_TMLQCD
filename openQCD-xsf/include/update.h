...
/* RWTM_XSF_C */
extern double rwtm1_xsf(double mu,int isp,double *sqn,int *status);
extern double rwtm1_act(double mu,int isp,double *sqn,int *status);
...
/* RWTMEO_XSF_C */
extern double rwtm1eo_xsf(double mu,int isp,double *sqn,int *status);
extern double rwtm1eo_act(double mu,int isp,double *sqn,int *status);
