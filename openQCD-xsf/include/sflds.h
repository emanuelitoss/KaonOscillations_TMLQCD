...
/* SCOM_C */
extern void cps_int_bnd_xsf(int is,spinor *s);
extern void cps_ext_bnd_xsf(int is,spinor *s);
extern void cps_int_bnd(int is,spinor *s);
extern void cps_ext_bnd(int is,spinor *s);
extern void free_sbufs(void);
   
/* SDCOM_C */
extern void cpsd_int_bnd_xsf(int is,spinor_dble *sd);
extern void cpsd_ext_bnd_xsf(int is,spinor_dble *sd);
