...
/* TMCG_XSF_C */
extern double tmcg_xsf(int nmx,double res,int tau3,double mu,
                   spinor_dble *eta,spinor_dble *psi,int *status);
extern double tmcgeo_xsf(int nmx,double res,int tau3,double mu,
                     spinor_dble *eta,spinor_dble *psi,int *status);
