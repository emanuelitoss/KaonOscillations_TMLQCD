...
/* DW_XSF_C */
extern void Dw_xsf(float mu,spinor *s,spinor *r);
extern void Dwee_xsf(float mu,spinor *s,spinor *r);
extern void Dwoo_xsf(float mu,spinor *s,spinor *r);
extern void Dweo_xsf(spinor *s,spinor *r);
extern void Dwoe_xsf(spinor *s,spinor *r);
extern void Dwhat_xsf(float mu,spinor *s,spinor *r);

/* DW_XSF_DBLE_C */
extern void Dw_xsf_dble(double mu,spinor_dble *s,spinor_dble *r);
extern void Dwee_xsf_dble(double mu,spinor_dble *s,spinor_dble *r);
extern void Dwoo_xsf_dble(double mu,spinor_dble *s,spinor_dble *r);
extern void Dweo_xsf_dble(spinor_dble *s,spinor_dble *r);
extern void Dwoe_xsf_dble(spinor_dble *s,spinor_dble *r);
extern void Dwhat_xsf_dble(double mu,spinor_dble *s,spinor_dble *r);
