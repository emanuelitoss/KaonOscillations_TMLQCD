...
for corr in np.arange(0,ncorr,1):
    if(isreal[corr]==True):
        for time in np.arange(0,ntimes,1):
            ...
            data_std[corr][time][0] = data_std[corr][time][0]/(nnoise*nnoise*volume3D)
    else:
        for time in np.arange(0,ntimes,1):
            for i1 in np.arange(0,nnoise,1):
                for i2 in np.arange(0,nnoise,1):
            ...
            data_std[corr][time][0] = data_std[corr][time][0]/(nnoise*nnoise*volume3D)
            data_std[corr][time][1] = data_std[corr][time][1]/(nnoise*nnoise*volume3D)
    ...
    if(isreal[corr]==True):
        for time in np.arange(0,ntimes,1):
            for i1 in np.arange(0,nnoise,1):
                ...
                data_gau[corr][time][0] = data_gau[corr][time][0]/(nnoise*nnoise*volume3D)
    else:
        for time in np.arange(0,ntimes,1):
            for i1 in np.arange(0,nnoise,1):
                for i2 in np.arange(0,nnoise,1):
            ...
            data_gau[corr][time][0] = data_gau[corr][time][0]/(nnoise*nnoise*volume3D)
            data_gau[corr][time][1] = data_gau[corr][time][1]/(nnoise*nnoise*volume3D)
    offset_idx+=nnoise*nnoise*ntimes*(2-isreal[corr])   
...
for corr in np.arange(0,ncorr,1):
    for time in np.arange(0,ntimes,1):
        check2 = abs(data_std[corr][time][0]-data_gau[corr][time][0])<EPSILON
        check2 = check2 and (abs(data_std[corr][time][1]-data_gau[corr][time][1])<EPSILON)
        if(check2==False):
